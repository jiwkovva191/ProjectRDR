  ...
  return (
    <div className="flex justify-center  min-h-screen bg-gray-100">
      <div className="bg-white w-full max-w-2xl  p-10 rounded shadow">
        <h1 className="text-4xl text-center mb-10">Add Skill</h1>

        <div className="mb-5">
          <label className="block text-xl mb-3">Skill Name</label>
        ...
        <div className="mb-5">
          <label className="block text-xl mb-3">Category</label>
        ...
        <div className="mb-8">
          <label className="block text-xl mb-3">Available Dates</label>
        ...
        <button
          className="w-full bg-black text-white text-xl py-5 rounded hover:bg-gray-800 transition"
          onClick={() => {
            void handleSubmit();
          }}
        >
